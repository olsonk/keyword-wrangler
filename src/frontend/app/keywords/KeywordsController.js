...
(function () {
    ...
    app.controller('KeywordsController', function ($scope, RepositoryFactory, resolveEntity) {
        ...
        /* resolveEntity is a helper which is used in partials/keywordCategoryGridCell.html in order
            to display the name of a keyword category based on its id */
        $scope.resolveEntity = resolveEntity;
        
        /* A repository is the connection between the controller and the REST API */
        /*  We use one for the keyword categories... */
        ...
        /* When the frontend loads, we want the controller to immediately load all keywords 
            and keyword categories from the API. */
        ...
        $scope.keywordsGridOptions = {
            ...
            columnDefs: [
                ...
                {
                    /* The Keyword Category field uses our own custom template */
                ...
                {
                    /* Same goes for operations column */
                    field: '',
        ...
        /* == Frontend Operations == */
        /* These functions are called when an action occurs (button click, etc) */
        ...
        /* These functions make the grid respond cleanly to selections */
